...
1. **Audit** with **claude-seo** (plugin - see install note) -> prioritized 0-100 action list (technical,
   ...
   audit manually against SEO-GUIDE's per-page-type checklists (§15/§16).*
...
ranking guarantees. Backlinks are the separate EARNED-only runbook (MONTHLY-OPS-GUIDE §5).
