...
name: voice-dna
description: >
  Build a reusable voice profile from ~20 of a person's real posts/transcripts so Claude writes in
  that specific voice (a client's, or your own). A per-person METHOD, not a static skill - build one
  voice-dna.md per client from their samples. Used by content-ops for on-brand copy and blog content.
---
